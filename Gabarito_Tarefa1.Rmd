...
Três arquivos fazem parte desta tarefa: `lego_colors.csv`, `lego_inventories.csv` e `lego_sales`.
...
```{r choose-set, message=FALSE, warning=FALSE}
...
```{r sets-colors, message=FALSE, warning=FALSE}
