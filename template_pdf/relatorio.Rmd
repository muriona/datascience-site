...
Esta Tarefa 2 servirá para vocês aplicarem os conhecimentos de visualização de dados e de apresentação das visualizações em formato de relatório (PDF) e de Dashboard.
...
-   Relatório em PDF, detalhando todas as ações feitas: limpeza de dados, agrupamentos, filtragens etc, bem como as análises e visualização de dados.
